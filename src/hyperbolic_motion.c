...
*/
void ln_get_hyp_helio_rect_posn(struct ln_hyp_orbit *orbit, double JD,
...
* elements for the given julian day. 
*/
void ln_get_hyp_geo_rect_posn(struct ln_hyp_orbit *orbit, double JD,
	struct ln_rect_posn *posn)
{
...
*/
void ln_get_hyp_body_equ_coords(double JD, struct ln_hyp_orbit *orbit,
	...
	struct ln_hyp_orbit *orbit, double horizon, struct ln_rst_time *rst)
{
	return ln_get_motion_body_rst_horizon(JD, observer,
		(get_motion_body_coords_t) ln_get_hyp_body_equ_coords, orbit,
		horizon, rst);
}
