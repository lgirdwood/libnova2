...
*/
double LIBNOVA_EXPORT ln2_get_julian_day(struct ln_date *date);
...
*/
void LIBNOVA_EXPORT ln2_get_date(double JD, struct ln_date *date);
...
* \param date Pointer to store date
*/
void LIBNOVA_EXPORT ln2_get_date_from_timet(time_t *t, struct ln_date *date);
...
* \param date Pointer to store date
*/
void LIBNOVA_EXPORT ln2_get_date_from_tm(struct tm *t, struct ln_date *date);
...
*/
void LIBNOVA_EXPORT ln2_get_local_date(double JD, struct ln_zonedate *zonedate);
...
*/
unsigned int LIBNOVA_EXPORT ln2_get_day_of_week(struct ln_date *date);
...
*/
double LIBNOVA_EXPORT ln2_get_julian_from_sys();
...
* \param date Pointer to store date
*/
void LIBNOVA_EXPORT ln2_get_date_from_sys(struct ln_date *date);
...
*/
double LIBNOVA_EXPORT ln2_get_julian_from_timet(time_t *in_time);
...
*/
void LIBNOVA_EXPORT ln2_get_timet_from_julian(double JD, time_t *in_time);
...
* \return Julian Day
*/
double LIBNOVA_EXPORT ln2_get_julian_local_date(struct ln_zonedate *zonedate);
...
*/
int LIBNOVA_EXPORT ln2_get_date_from_mpc(struct ln_date *date, char *mpc_date);
...
* See http://cfa-www.harvard.edu/iau/info/PackedDates.html
*/
double LIBNOVA_EXPORT ln2_get_julian_from_mpc(char *mpc_date);
...
*/
void LIBNOVA_EXPORT ln2_date_to_zonedate(struct ln_date *date, struct ln_zonedate *zonedate, long gmtoff);
...
* \param date Pointer to store date
*/
void LIBNOVA_EXPORT ln2_zonedate_to_date(struct ln_zonedate *zonedate, struct ln_date *date);
