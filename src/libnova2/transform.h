 ...
 * Referenced to the equator and equinox of a specific epoch (usually J2000.0).
 * - **Ecliptic Coordinates**: Longitude and Latitude. Referenced to the
 * ecliptic plane.
 * - **Horizontal Coordinates**: Azimuth and Altitude. Topocentric coordinates
 * relative to the observer's local horizon.
 * - **Galactic Coordinates**: Longitude (l) and Latitude (b). Referenced to the
 * galactic plane.
 *
 ...
 *
 * Meeus Chapter 13. Uses the observer's longitude and latitude and the sidereal
 * time at Greenwich (calculated from JD).
 */
...
/**
 * \ingroup transform
 * \brief Transform an objects rectangular coordinates into ecliptical
 * coordinates.
...
/**
 * \ingroup transform
 * \brief Transform an object galactic coordinate into J2000 equatorial
 * coordinates.
 * \param gal Galactic position of object
...
/**
 * \ingroup transform
 * \brief Transform an object J2000 equatorial coordinates into galactic
 * coordinates.
