 ...
 *
 * The Julian Day (JD) is a continuous count of days since the beginning of the
 * Julian Period (January 1, 4713 BC at noon UT). It is the primary time
 * variable used in astronomical calculations.
 *
 ...
 * \return Julian Day
 *
 * Formula 7.1 (Meeus). Valid for positive and negative years (using
 * astronomical year numbering, where 0 = 1 BC, -1 = 2 BC, etc.).
 */
double LIBNOVA2_EXPORT ln2_get_julian_day(struct ln_date *date);
 ...
 */
void LIBNOVA2_EXPORT ln2_get_date(double JD, struct ln_date *date);
 ...
 * \param date Pointer to store date
 */
void LIBNOVA2_EXPORT ln2_get_date_from_timet(time_t *t, struct ln_date *date);
 ...
 * \param date Pointer to store date
 */
void LIBNOVA2_EXPORT ln2_get_date_from_tm(struct tm *t, struct ln_date *date);
 ...
 */
unsigned int LIBNOVA2_EXPORT ln2_get_day_of_week(struct ln_date *date);
 ...
 */
double LIBNOVA2_EXPORT ln2_get_julian_from_sys();
 ...
 * \param date Pointer to store date
 */
void LIBNOVA2_EXPORT ln2_get_date_from_sys(struct ln_date *date);
 ...
 */
double LIBNOVA2_EXPORT ln2_get_julian_from_timet(time_t *in_time);
 ...
 */
void LIBNOVA2_EXPORT ln2_get_timet_from_julian(double JD, time_t *in_time);
 ...
 * \return Julian Day
 */
double LIBNOVA2_EXPORT ln2_get_julian_local_date(struct ln_zonedate *zonedate);
 ...
 */
int LIBNOVA2_EXPORT ln2_get_date_from_mpc(struct ln_date *date, char *mpc_date);
 ...
 * See http://cfa-www.harvard.edu/iau/info/PackedDates.html
 */
double LIBNOVA2_EXPORT ln2_get_julian_from_mpc(char *mpc_date);
