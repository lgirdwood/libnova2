 ...
 *
 * Functions relating to Dynamical Time (TD), which is the uniform time scale
 * used in the ephemerides.
 *
 * - **Delta T (\f$ \Delta T \f$)**: The difference between Dynamical Time (TD)
 ...
 *
 * Uses polynomial approximations to estimate \f$ \Delta T \f$ for the given
 * date.
 */
