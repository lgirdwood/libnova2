 ...
 *
 * The apparent position of a star is its position as seen from the center of
 * the Earth.
 *
 ...
 * - **Proper Motion**: The star's intrinsic motion across the sky (if
 * provided).
 *
 * The geometric position (mean position) is transformed to the apparent
 * position.
 *
 ...
 * \ingroup apparent
 * \param mean_position Mean position of the star (at J2000.0 or other standard
 * epoch)
 * \param proper_motion Proper motion of the star (optional, set components to 0
 * if unknown)
 * \param JD Julian Day
 ...
 */
void LIBNOVA2_EXPORT ln2_get_apparent_posn(struct ln_equ_posn *mean_position,
