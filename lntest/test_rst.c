...
int hyp_future_rst_test(void)
{
	...
	circumpolar = ln2_get_hyp_body_next_rst_horizon(JD, &observer, &orbit, 0, &rst);
...
int body_future_rst_test(void)
{
	...
	circumpolar = ln2_get_body_next_rst_horizon_future(JD, &observer, ln2_get_solar_equ_coords, LN_SOLAR_STANDART_HORIZON,
													  300, &rst);
