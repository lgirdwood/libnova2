...
int nutation_test(void)
{
	...
	failed += test_result_dms("(Nutation) obliquity (deg) for JD 2446895.5", LN_R2D(nutation.obliquity),
							  9.443 / (60.0 * 360.0), LN_R2D(0.000001));

	failed += test_result_dms("(Nutation) ecliptic (deg) for JD 2446895.5", LN_R2D(nutation.ecliptic),
							  23.0 + 26.0 / 60.0 + 27.407 / (60.0 * 360.0), LN_R2D(0.000001));
	...
	failed += test_result_dms("(Nutation) obliquity (deg) for JD 2462088.69", LN_R2D(nutation.obliquity),
							  2.705 / (60.0 * 360.0), LN_R2D(0.000001));

	failed += test_result_dms("(Nutation) ecliptic (deg) for JD 2462088.69", LN_R2D(nutation.ecliptic),
							  LN_R2D(0.40899523), LN_R2D(0.000001));
