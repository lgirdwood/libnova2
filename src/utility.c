 ...
 * e.g. "0.4.0"
 */
const char *ln_get_version(void) { return ln_version; }

/* convert radians to degrees */
double ln_rad_to_deg(double radians) { return (radians * R2D); }

/* convert degrees to radians */
double ln_deg_to_rad(double degrees) { return (degrees * D2R); }
 ...
 * \ingroup conversion
 */
void ln_hlnlat_to_lnlat(struct lnh_lnlat_posn *hpos,
 ...
 * \ingroup conversion
 */
void ln_lnlat_to_hlnlat(struct ln_lnlat_posn *pos,
 ...
 */
double ln_get_light_time(double dist) { return dist * 0.005775183; }
