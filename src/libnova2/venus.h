...
*/
double LIBNOVA2_EXPORT ln2_get_venus_sdiam(double JD);
...
*/
int LIBNOVA2_EXPORT ln2_get_venus_rst(double JD, struct ln_lnlat_posn *observer, struct ln_rst_time *rst);
...
void LIBNOVA2_EXPORT ln2_get_venus_helio_coords(double JD, struct ln_helio_posn *position);
...
*/
/* Chapter 31 Pg 206-207 Equ 31.1 31.2 , 31.3 using VSOP 87 */
void LIBNOVA2_EXPORT ln2_get_venus_equ_coords(double JD, struct ln_equ_posn *position);
...
*/
/* Chapter ?? */
double LIBNOVA2_EXPORT ln2_get_venus_earth_dist(double JD);
...
*/
/* Chapter ?? */
double LIBNOVA2_EXPORT ln2_get_venus_solar_dist(double JD);
...
*/
/* Chapter ?? */
double LIBNOVA2_EXPORT ln2_get_venus_magnitude(double JD);
...
*/
/* Chapter 41 */
double LIBNOVA2_EXPORT ln2_get_venus_disk(double JD);
...
*/
/* Chapter 41 */
double LIBNOVA2_EXPORT ln2_get_venus_phase(double JD);
...
*/
void LIBNOVA2_EXPORT ln2_get_venus_rect_helio(double JD, struct ln_rect_posn *position);
