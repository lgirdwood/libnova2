...
*/
int LIBNOVA_EXPORT ln2_get_object_rst(double JD, struct ln_lnlat_posn *observer, struct ln_equ_posn *object,
...
* \return 0 for success, 1 for circumpolar, -1 for never rises
*/
int LIBNOVA_EXPORT ln2_get_object_rst_horizon(double JD, struct ln_lnlat_posn *observer, struct ln_equ_posn *object,
											 long double horizon, struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln2_get_object_rst_horizon_offset(double JD, struct ln_lnlat_posn *observer,
...
* \return 0 for success, 1 for circumpolar, -1 for never rises
*/
int LIBNOVA_EXPORT ln2_get_object_next_rst(double JD, struct ln_lnlat_posn *observer, struct ln_equ_posn *object,
										  struct ln_rst_time *rst);
...
* \return 0 for success, 1 for circumpolar, -1 for never rises
*/
int LIBNOVA_EXPORT ln2_get_object_next_rst_horizon(double JD, struct ln_lnlat_posn *observer, struct ln_equ_posn *object,
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_body_rst_horizon(double JD, struct ln_lnlat_posn *observer,
										   void (*get_equ_body_coords)(double, struct ln_equ_posn *), double horizon,
										   struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln2_get_body_rst_horizon_offset(double JD, struct ln_lnlat_posn *observer,
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_body_next_rst_horizon(double JD, struct ln_lnlat_posn *observer,
												void (*get_equ_body_coords)(double, struct ln_equ_posn *),
												double horizon, struct ln_rst_time *rst);
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_body_next_rst_horizon_future(double JD, struct ln_lnlat_posn *observer,
													   void (*get_equ_body_coords)(double, struct ln_equ_posn *),
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_motion_body_rst_horizon(double JD, struct ln_lnlat_posn *observer,
												  get_motion_body_coords_t get_motion_body_coords, void *orbit,
												  double horizon, struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln2_get_motion_body_rst_horizon_offset(double JD, struct ln_lnlat_posn *observer,
														 get_motion_body_coords_t get_motion_body_coords, void *orbit,
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_motion_body_next_rst_horizon(double JD, struct ln_lnlat_posn *observer,
													   get_motion_body_coords_t get_motion_body_coords, void *orbit,
													   double horizon, struct ln_rst_time *rst);
 ...
 * \return 0 for success, 1 for circumpolar, -1 for never rises
 */
int LIBNOVA_EXPORT ln2_get_motion_body_next_rst_horizon_future(double JD, struct ln_lnlat_posn *observer,
