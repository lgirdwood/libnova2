 ...
 * time.
 *
 * - **General Precession**: The combined effect of luni-solar precession and
 * planetary precession.
 * - **Annual Precession**: The amount of precession in one year (approx 50.29
 * arcseconds).
...
/**
 * \brief Calculate the effects of precession on equatorial coordinates, convert
 * current to J2000.
 * \ingroup precession
...
/**
 * \brief Calculate the effects of precession on equatorial coordinates, between
 * arbitary Jxxxx epochs.
 * \ingroup precession
 * \param mean_position Mean equatorial position
