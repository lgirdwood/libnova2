 ...
 *
 * Functions relating to the angular separation and position angle between 2
 * bodies.
 *
 * - **Angular Separation**: The shortest apparent distance on the celestial
 * sphere.
 * - **Position Angle**: Angle measured eastward from the North Celestial Pole
 * to the object.
 *
 ...
 *
 * Uses the spherical cosine formula or Haversine formula for better precision
 * at small angles (Meeus Formula 17.1).
 */
