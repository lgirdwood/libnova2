...
/**
 * \brief Calculate the time of rise, set and transit for an object not orbiting
 * the Sun.
 * \ingroup rst
 * \param JD Julian Day
 ...
 * orbiting the Sun. E.g. it's sure, that rise, set and transit will be in <JD,
 * JD+1> range. This function is not too precise, it's good to get general idea
 * when object will rise.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
 * \param object Equatorial position of object
 ...
 * body, usually Sun, a planet or Moon. E.g. it's sure, that rise, set and
 * transit will be in <JD, JD+1> range.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
 * \param get_equ_body_coords Function to get body's equatorial coordinates
 ...
 * \brief Calculate the time of next  rise, set and transit for an object a
 * body, usually Sun, a planet or Moon. E.g. it's sure, that rise, set and
 * transit will be in <JD, JD+day_limit> range.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
 * \param get_equ_body_coords Function to get body's equatorial coordinates
...
/**
 * \brief Calculate the time of rise, set and transit for an object a body on
 * elliptic, parabolic or hyperbolic orbit.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
...
/**
 * \brief Calculate the time of next  rise, set and transit for an object a body
 * on elliptic, parabolic or hyperbolic orbit. E.g. it's sure, that rise, set
 * and transit will be in <JD, JD+1> range.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
 * \param get_motion_body_coords Function to get body's motion coordinates
 ...
 * \brief Calculate the time of next  rise, set and transit for an object a body
 * on elliptic, parabolic or hyperbolic orbit. E.g. it's sure, that rise, set
 * and transit will be in <JD, JD+day_limit> range.
 * \ingroup rst
 * \param JD Julian Day
 * \param observer Observer's position
 * \param get_motion_body_coords Function to get body's motion coordinates
