...
*/
double LIBNOVA_EXPORT ln2_get_angular_separation(struct ln_equ_posn *posn1, struct ln_equ_posn *posn2);
...
*/
double LIBNOVA_EXPORT ln2_get_rel_posn_angle(struct ln_equ_posn *posn1, struct ln_equ_posn *posn2);
