...
{ 
	...
	date.seconds = 0;
	JD = ln_get_julian_day(&date);
	failed += test_result("(Julian Day) JD for 01/01/1987 00:00:00",
		JD, 2446796.5, 0.00001);
	...
	date.seconds = 0;
	JD = ln_get_julian_day(&date);
	failed += test_result("(Julian Day) JD for 01/01/1900 00:00:00",
		JD, 2415020.5, 0.00001);
	...
	date.seconds = 0;
	JD = ln_get_julian_day(&date);
	failed += test_result("(Julian Day) JD for 01/01/1600 00:00:00",
		JD, 2305447.5, 0.00001);
	...
	date.seconds = 0;
	JD = ln_get_julian_day(&date);
	failed += test_result("(Julian Day) JD for 31/12/1600 00:00:00",
		JD, 2305812.5, 0.00001);
	...
	date.seconds = 24;
	JD = ln_get_julian_day(&date);
	failed += test_result("(Julian Day) JD for 10/04/1957 19:26:24",
		JD, 2436116.31, 0.00001);
